      ...
      <div className="fixed inset-0 bg-gradient-to-br from-[#2059a1] via-[#153f75] to-[#ecbf21]/50 flex flex-col items-center justify-center z-[999] overflow-hidden animate-fade-in">
        ...
        <div className="bg-slate-900/90 border border-slate-800 backdrop-blur-md rounded-3xl p-10 max-w-md w-full mx-4 shadow-2xl text-center space-y-6 animate-scale-in text-white">
          ...
          <div className="space-y-2">
            ...
            <p className="text-[#ecbf21] font-bold text-lg">Quiz Created Successfully</p>
      ...
      <div className="max-w-4xl mx-auto space-y-8 py-12 text-white animate-fade-in">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-12">
          <button
            ...
            className="group p-8 bg-slate-900/40 rounded-3xl border border-slate-800 hover:border-[#2059a1] hover:bg-slate-900/60 shadow-sm hover:shadow-2xl transition-all text-left space-y-4"
          >
            <div className="w-16 h-16 bg-[#2059a1]/10 rounded-2xl flex items-center justify-center text-[#2059a1] group-hover:bg-[#2059a1] group-hover:text-white transition-all border border-[#2059a1]/10">
          ...
          <div className="space-y-5">
            <div className="space-y-1.5">
              ...
              <input 
                ...
                className="w-full px-4 py-3 bg-slate-950 border border-slate-800 rounded-xl focus:ring-2 focus:ring-[#2059a1] text-white outline-none font-medium placeholder-slate-500 transition-all duration-200" 
            ...
            <button 
              ...
              className="w-full bg-[#2059a1] text-white py-4 rounded-xl font-bold text-lg flex items-center justify-center gap-2 hover:bg-[#1a4b87] disabled:opacity-50 disabled:cursor-not-allowed transition-all shadow-lg shadow-[#2059a1]/10 mt-2"
            >
              {aiLoading ? (
                <>
    ...
    <div className="max-w-4xl mx-auto space-y-8 pb-32 pt-6 text-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="col-span-2 space-y-1.5">
            ...
            <textarea 
              ...
              className="w-full px-4 py-3 bg-slate-950 border border-slate-800 rounded-xl focus:ring-2 focus:ring-[#2059a1] text-white outline-none font-medium placeholder-slate-500 transition-all duration-200 h-24 resize-none" 
          ...
          <div className="space-y-1.5">
            ...
            <input 
              type="datetime-local" 
              className="w-full px-4 py-3 bg-slate-950 border border-slate-800 rounded-xl focus:ring-2 focus:ring-[#2059a1] text-white outline-none font-medium transition-all duration-200 [color-scheme:dark]" 
      ...
      <div className="space-y-6 animate-fade-in-up">
          ...
          <div key={q.id} className="bg-slate-900 border border-slate-800 p-8 rounded-3xl shadow-xl space-y-6 hover:shadow-2xl transition-all">
            ...
            <div className="space-y-1.5">
              ...
              <textarea 
                ...
                className="w-full px-4 py-3 bg-slate-950 border border-slate-800 rounded-xl focus:ring-2 focus:ring-[#2059a1] text-white outline-none font-medium placeholder-slate-500 transition-all duration-200 h-20 resize-none" 
                value={q.text} 
                  ...
                  <div key={oIdx} className={`flex items-center gap-3 p-2 rounded-xl border transition-all ${
                    ...
                    <label className="relative flex items-center justify-center cursor-pointer pl-2">
                      ...
                      <div className={`w-5 h-5 rounded-full border flex items-center justify-center transition-all ${
                        q.correctAnswer === oIdx
                          ? 'border-[#2059a1] bg-[#2059a1] text-white'
        ...
        <button 
          ...
          className="w-full py-4 border-2 border-dashed border-slate-800 hover:border-[#2059a1] hover:bg-[#2059a1]/5 rounded-2xl text-[#2059a1] font-bold transition-all duration-200 flex items-center justify-center gap-2 shadow-sm"
        >
      ...
      <button 
        onClick={handleSave} 
        className="fixed bottom-8 right-8 bg-[#ecbf21] text-slate-950 px-8 py-3.5 rounded-full shadow-2xl hover:bg-[#c59e13] hover:scale-105 active:scale-95 transition-all duration-200 flex items-center gap-2.5 font-black z-50 border border-yellow-500/10"
      >
